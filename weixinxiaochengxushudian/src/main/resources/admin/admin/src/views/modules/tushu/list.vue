                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/weixinxiaochengxushudian/upload/tushuMuBan.xls"
                        >批量导入图书数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('tushu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   ...
                                   label="出版社">
                        <template slot-scope="scope">
                            {{scope.row.tushuChubanshe}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="tushuFile"
                                     header-align="center"
                                     width="200"
                                     label="图书下载">
                        <template slot-scope="scope">
                            <div v-if="scope.row.tushuFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="scope.row.tushuFile"  >下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.tushuKucunNumberTitle = '增加库存'
			},
			//减少库存
			...
			//数据不为空放值
				...
				this.tushuKucunNumberVisible = true;
				//标题
				this.tushuKucunNumberTitle = '减少库存'
			},
			//提交用户操作库存数量
			addTushuKucunNumber(){
				var type = null
