                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/weixinxiaochengxushudian/upload/tushuOrderMuBan.xls"
                        >批量导入图书订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('tushuOrder','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'tushu_order',//当前表表名,
                        sumColum : 'tushu_order_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'tushu_order_name',//分组字符串字段
                        // types : 'tushu_order_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
