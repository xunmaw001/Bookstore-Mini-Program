    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单号" prop="tushuOrderUuidNumber">
                       <el-input v-model="ruleForm.tushuOrderUuidNumber"
                                 placeholder="订单号" clearable  :readonly="ro.tushuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单号" prop="tushuOrderUuidNumber">
                           <el-input v-model="ruleForm.tushuOrderUuidNumber"
